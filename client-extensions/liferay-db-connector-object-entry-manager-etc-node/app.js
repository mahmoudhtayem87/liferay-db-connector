...
import dbActions from './actions/db-actions.js'
import dynamicDbConnector from './entry-manager/db-connect.js';
...
app.use('/actions/db/', dbActions);
app.use('/dynamic/db', dynamicDbConnector);
